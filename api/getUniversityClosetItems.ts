...
const getUniversityClosetItems= async(universityId: string) => {
    ...
    const universityClosetResponse = await fetch(`${URL}/closetItem/user/${universityId}`);
...
export default getUniversityClosetItems;